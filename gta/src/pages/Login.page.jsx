    ...
    return (
        <AnimationWrapper>
            ...
            <div className="flex relative justify-center items-center min-h-screen bg-gray-100">
                <div className="bg-white relative rounded-3xl shadow-xl flex items-center justify-between overflow-hidden px-2 max-w-4xl z-10 ">
                        ...
                        <div className="classical-login my-10">
                            ...
                            <form onSubmit={(e) => handleFormSubmit(e)} >
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button type="submit" className="cursor-pointer py-2 px-6 border-[1px] bg-slate-50 text-slate-600 font-light uppercase text-sm border-slate-400 hover:border-amber-500 rounded-full ">Sign in</button>
                                </div>
                            </form>
                ...
                {/* footer */}
                <div className="absolute bottom-3 w-full text-center font-light text-slate-500 text-sm mt-5">
